...
- **R13 — About `/about`:** Includes USACH Ing. Ejecución Computación e Informática (Mar 2020–Apr 2025), thesis WealthQuest (Blended Games) + publication (May 2025, co-authors including Soto Aguilar), languages (Spanish native, English basic technical reading), and fact-only bio. All facts traceable to CV.
